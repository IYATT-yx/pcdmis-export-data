...
# By python version 3.14.5 (tags/v3.14.5:5607950, May 10 2026, 10:43:50) [MSC v.1944 64 bit (AMD64)]
# From type library 'Pcdlrn.tlb'
# On Thu Jun 18 21:07:48 2026
'PC-DMIS 2025.1 Object Library'
...
CLSID = IID('{F7541F48-6D30-4DCC-9F72-9E4A6B1EFBBF}')
MajorVersion = 20
MinorVersion = 1
LibraryFlags = 8
LCID = 0x0
...
class constants:
	...
	BOTH                          =2          # from enum BladeFlankEnum
	CC                            =1          # from enum BladeFlankEnum
	CV                            =0          # from enum BladeFlankEnum
	...
	MinusX                        =1          # from enum DirectionTypeEnum
	MinusY                        =3          # from enum DirectionTypeEnum
	MinusZ                        =5          # from enum DirectionTypeEnum
	PR_2D                         =6          # from enum DirectionTypeEnum
	PR_3D                         =7          # from enum DirectionTypeEnum
	PlusX                         =0          # from enum DirectionTypeEnum
	PlusY                         =2          # from enum DirectionTypeEnum
	PlusZ                         =4          # from enum DirectionTypeEnum
	...
	F_2DRADIUS                    =26         # from enum ENUM_FEATURE_TYPES
	...
	F_FACE                        =23         # from enum ENUM_FEATURE_TYPES
	F_GAGE                        =25         # from enum ENUM_FEATURE_TYPES
	F_LINE                        =4          # from enum ENUM_FEATURE_TYPES
	F_MESH                        =24         # from enum ENUM_FEATURE_TYPES
	...
	F_WIDTH1D                     =27         # from enum ENUM_FEATURE_TYPES
	...
	ASME_Y14_5                    =1          # from enum GDTTYPE
	ISO_1101                      =0          # from enum GDTTYPE
	...
	ADAPTIVE_CIRCLE_SCAN_STRATEGY =7          # from enum MeasurementStrategies
	ADAPTIVE_CONE_CONCENTRIC_CIRCLE_SCAN_STRATEGY=13         # from enum MeasurementStrategies
	ADAPTIVE_CONE_LINE_SCAN_STRATEGY=14         # from enum MeasurementStrategies
	ADAPTIVE_CYLINDER_CONCENTRIC_CIRCLE_SCAN_STRATEGY=11         # from enum MeasurementStrategies
	ADAPTIVE_CYLINDER_LINE_SCAN_STRATEGY=9          # from enum MeasurementStrategies
	ADAPTIVE_CYLINDER_SPIRAL_SCAN_STRATEGY=10         # from enum MeasurementStrategies
	ADAPTIVE_LINEAR_SCAN_STRATEGY =6          # from enum MeasurementStrategies
	CYLINDER_CENTERING_THREAD_SCAN_STRATEGY=12         # from enum MeasurementStrategies
	DEFAULT_PCDMIS_MEASUREMENT_STRATEGY=-1         # from enum MeasurementStrategies
	GAGE_SCAN_CALIBRATION_STRATEGY=8          # from enum MeasurementStrategies
	PLANE_CIRCLE_SCAN_STRATEGY    =1          # from enum MeasurementStrategies
	PLANE_FREE_FORM_SCAN_STRATEGY =0          # from enum MeasurementStrategies
	PLANE_LINE_ADAPTIVE_SCAN_STRATEGY=2          # from enum MeasurementStrategies
	SELF_CENTERING_POINT_STRATEGY =15         # from enum MeasurementStrategies
	TTP_PLANE_CIRCLE_STRATEGY     =4          # from enum MeasurementStrategies
	TTP_PLANE_FREE_FORM_STRATEGY  =3          # from enum MeasurementStrategies
	TTP_PLANE_USER_DEFINED_STRATEGY=5          # from enum MeasurementStrategies
	...
	BranchMismatchError           =8          # from enum OpenRoutineStatus
	CannotOpenRoutineFile         =4          # from enum OpenRoutineStatus
	DeserializationError          =7          # from enum OpenRoutineStatus
	ErrorClosingRoutineFile       =5          # from enum OpenRoutineStatus
	InternalError                 =3          # from enum OpenRoutineStatus
	OpenedBackupCopy              =2          # from enum OpenRoutineStatus
	PcdmisIsOpeningAnotherRoutine =10         # from enum OpenRoutineStatus
	RoutineFileDoesNotExist       =6          # from enum OpenRoutineStatus
	RoutineIsNewerError           =9          # from enum OpenRoutineStatus
	RoutineIsTooOldError          =11         # from enum OpenRoutineStatus
	RoutineOpened                 =1          # from enum OpenRoutineStatus
	UnknownStatus                 =0          # from enum OpenRoutineStatus
	...
	CurrentAlign                  =0          # from enum RelativeTo
	UserDefined                   =1          # from enum RelativeTo
...
CLSIDToPackageMap = {
	...
	'{5A470BBD-B7EC-41AE-93FD-EC475FF2AA55}' : 'IDigitalThreadID',
	...
	'{A27788D5-1998-48BC-B040-E6A5E3FA2353}' : 'IDigitalThreadIDPairArray',
	'{64F9589C-BADC-423C-BC72-C949EC7A3FAA}' : 'IDigitalThreadIDPair',
	...
	'{5B1FB875-BF48-494D-A526-3183D7EA7CF4}' : 'IToleranceCommand',
	'{6731C93C-8EFE-454D-ACFC-3AF817E0FF2C}' : 'IDigitalThreadIDArray',
	'{F506142E-46A9-423E-A36F-0A4395664FF2}' : 'IBladeScanCommand',
	...
	'{2318C82E-1868-49B0-BE68-4370FBD70E41}' : 'IMiniroutineInfoList',
	'{E715A47B-2D5B-4906-9594-9D353B711726}' : 'IMiniroutineInfo',
	'{9404E08A-A486-4FEA-8352-63CBC438F33C}' : 'IMarkedSetInfoList',
	'{90D4DBD9-335A-47F0-9AC7-CB5E3EFD4EEE}' : 'IMarkedSetInfo',
	...
	'{ABE5A659-0598-498B-ABB2-584B8A6D398C}' : 'IHullLicense',
	...
	'{8433D173-5E48-4E08-AB83-066393C3D019}' : 'Application',
	...
	'{9EFAC8D6-ECF0-4D71-A8A4-06189DDD351F}' : 'DigitalThreadIDPair',
	'{4A57D090-32F4-4C87-B9DB-537352ED7F35}' : 'DigitalThreadIDPairArray',
	'{592BD3FE-65D1-4296-91B8-97B95FE9C8A0}' : 'DigitalThreadIDArray',
	...
	'{DFF96072-D9FA-49AD-B84A-1105ACBC8F68}' : 'HullLicense',
	...
	'{F515CF88-B3ED-42DF-B9C2-2ED39A160E81}' : 'ToleranceCommand',
	...
	'{452469B1-99D4-4545-A6CD-6238BAAC582E}' : 'MiniroutineInfo',
	'{46A47F87-988C-487D-90F2-5E412BD6C672}' : 'MiniroutineInfoList',
	'{47F19C63-D986-47C5-AC07-C964DDCBB3C1}' : 'MarkedSetInfo',
	'{9C02DFAE-3477-4F1B-B7F5-F0500BF77E9F}' : 'MarkedSetInfoList',
	...
	'{7074CA1D-2E0F-4F4E-9659-684B9F74CF78}' : 'BladeScanCommand',
	'{7DF7913E-ABF3-4148-A1A9-3D6EC734E6C1}' : 'DigitalThreadID',
}
VTablesToClassMap = {}
VTablesToPackageMap = {
}
...
NamesToIIDMap = {
	...
	'IDigitalThreadID' : '{5A470BBD-B7EC-41AE-93FD-EC475FF2AA55}',
	...
	'IDigitalThreadIDPairArray' : '{A27788D5-1998-48BC-B040-E6A5E3FA2353}',
	'IDigitalThreadIDPair' : '{64F9589C-BADC-423C-BC72-C949EC7A3FAA}',
	...
	'IToleranceCommand' : '{5B1FB875-BF48-494D-A526-3183D7EA7CF4}',
	'IDigitalThreadIDArray' : '{6731C93C-8EFE-454D-ACFC-3AF817E0FF2C}',
	'IBladeScanCommand' : '{F506142E-46A9-423E-A36F-0A4395664FF2}',
	...
	'IMiniroutineInfoList' : '{2318C82E-1868-49B0-BE68-4370FBD70E41}',
	'IMiniroutineInfo' : '{E715A47B-2D5B-4906-9594-9D353B711726}',
	'IMarkedSetInfoList' : '{9404E08A-A486-4FEA-8352-63CBC438F33C}',
	'IMarkedSetInfo' : '{90D4DBD9-335A-47F0-9AC7-CB5E3EFD4EEE}',
	...
	'IHullLicense' : '{ABE5A659-0598-498B-ABB2-584B8A6D398C}',
