...
PC-DMIS 数据导出工具  
这个项目最初来自同事的提议，他们希望可以批量抓取数据，避免客户需要检测数据的时候花费大量人力去抄录。特别是对于新开发的项目，方便通过汇总数据监管过程。我从 2025 年 2 月中开始构思，当时距离春节还有十几天，主体写于春节后几天，后续不断完善。    
...
* PC-DMIS 版本（正在测试）：2018 R1、2019 R2、2023.1、2023.2、2025.1  
